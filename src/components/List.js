                    ...
                    <div className="col-9 float-left pl-2">
                        ...
                        <div className="UnderlineNav user-profile-nav js-sticky top-0" style={{position: 'static', top: '0px', left: '403.5px', width: '727px'}}>
                            <nav className="UnderlineNav-body" data-pjax="" role="navigation">
                                ...
                                <a href="/wallaceyuan?tab=repositories" className="UnderlineNav-item " aria-selected="false" role="tab" title="Repositories">Repositories<span className="Counter">{info.public_repos}</span>
                                </a>
                                <a href="/wallaceyuan?tab=followers" className="UnderlineNav-item " aria-selected="false" role="tab" title="Followers">Followers<span className="Counter">{info.followers}</span>
                                </a>
                                <a href="/wallaceyuan?tab=following" className="UnderlineNav-item " aria-selected="false" role="tab" title="Following">Following<span className="Counter">{info.following}</span>
                                </a>
                            </nav>
                        </div>
                    </div>
